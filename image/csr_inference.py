...
python ./csr_inference.py \
      --train_emb_path ./CSR-precompute-embeds/FF2048_RN50_Embeds/train_chunks \
      --eval_emb_path ./CSR-precompute-embeds/FF2048_RN50_Embeds/val_chunks \
      --model_name "resnet50d.ra4_e3600_r224_in1k" \
      --topk 8 \
      --hidden-size 8192 \
      --csr-ckpt ./ckpt/CSR_topk_8/checkpoint_9.pth
"""
